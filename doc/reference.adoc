...
// [source]
// ----
// bool boost_flags_enable(E) { return true; }
...
// [source]
// ----
// constexpr operator&&(e1, e2) -> bool { return !!(e1 & e2); }
// ----
// 
...
(cf. xref:BOOST_FLAGS[`BOOST_FLAGS_LOGICAL_AND`])
...
// The macro xref:BOOST_FLAGS_DELETE_REL[BOOST_FLAGS_DELETE_REL] can be used to delete relational operators.
// // There are macros xref:BOOST_FLAGS_REL_OPS_PARTIAL_ORDER[BOOST_FLAGS_REL_OPS_PARTIAL_ORDER] to overload and xref:BOOST_FLAGS_DELETE_REL[BOOST_FLAGS_DELETE_REL] to delete relational operators.

// [WARNING]
// ====
// It is recommended to define `BOOST_FLAGS_DELETE_REL` for flag-like enumerations.
...
// When flags have to be stored in ordered container or sorted, the macro `BOOST_FLAGS_SPECIALIZE_STD_LESS(E)` to specialize `std::less`.
...
// ----
//     template<typename E> 
//     flag_generator<E> flags_from_to(E first, E last);
// ----
...
// ----
//     template<typename E> 
//     flag_generator<E> flags_to(E last);
// ----
